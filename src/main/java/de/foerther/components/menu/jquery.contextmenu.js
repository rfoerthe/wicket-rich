...
;(function($){
	$.contextMenu = {
		...
		theme:'default',
        clickEvent:'contextmenu', // which mouse button will activate contextMenu ('click' for left button, 'contextmenu' for right button)
	...
	$.fn.contextMenu = function(menu,options) {
		...
		return this.each(function(){
			$(this).bind(cmenu.clickEvent,function(e){cmenu.show(this,e);return false;});
		});
	};
})(jQuery);
